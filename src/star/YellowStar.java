...
//Public class for the yellow star collectible
public class YellowStar extends Star{

//Fields
	protected int colourCode1 = 204;
	protected int colourCode2 = 204;
	protected int colourCode3 = 0;
...
//Constructor
		public YellowStar(double x, double y, double velX, double velY, double s)
		{
